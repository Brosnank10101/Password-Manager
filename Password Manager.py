...
#The Main Menu Is within a function so the code inside the function can be run as many times as the 
...
def main():
  ...
  #Asking The To Enter An Input
    ...
    #If The Users Input Is Vaild it will continue the program
      ...
      #This occurs if the user wants to exit the 
        ...
        while True:
          ...
          while number_input.lower() not in ('yes','no'):
            ...
            if password_count > password_length:
              ...
              #adds items if the list has not enought items
            ...
            while save1_input.lower() not in ('yes','no'):
              ...
              if save1_input == 'yes':
                ...
                while save2_input.lower() not in ('yes','no'):
                  ...
                  #this occurs if the usser wants to save a message
                  if save2_input == 'yes':
                    ...
                    #If the user doesnt want to save a message
                    file = open("Passwords.txt", "a")
                    file.write('\n')
                    file.close()
                    print('')
                ...
                #if the user doesnt want to save a password
                main()
                break
            main
            break
      ...
      #Deleting Saved Passwords - User Option Two  
